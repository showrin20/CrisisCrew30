          ...
          <footer class="footer mt-4">
              <div class="container">
                  <div class="row">
                      <!-- Contact Information -->
                      <div class="col-md-6 col-lg-6 col-12 mt-4 mt-md-0">
                          <p>Email: <a href="mailto:info@crisidscrew.com"  style="color: white; text-decoration: none;">crisiscrew23@gmail.com
                          </a><br>
                             Developed By:<br> Showrin Rahman<br>CTO ,CrisisCrew<br>
